...
public class FileFragmentTypeSupport extends TypeSupportImpl {
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (((com.rti.examples.JavaDDSFileTransfer.FILE_NAME_LENGTH_MAX.VALUE)))+1);
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.BYTE.getSequenceMaxSizeSerialized(currentAlignment, ((com.rti.examples.JavaDDSFileTransfer.FILE_FRAGMENT_SIZE_MAX.VALUE)));
        if (include_encapsulation) {
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.file_name,((com.rti.examples.JavaDDSFileTransfer.FILE_NAME_LENGTH_MAX.VALUE)));
            ...
            dst.writeByteSeq(typedSrc.frag,((com.rti.examples.JavaDDSFileTransfer.FILE_FRAGMENT_SIZE_MAX.VALUE)));
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            typedDst.clear();      
            try{
                typedDst.file_name = src.readString(((com.rti.examples.JavaDDSFileTransfer.FILE_NAME_LENGTH_MAX.VALUE)));
                typedDst.file_size = src.readInt();
                typedDst.frag_num = src.readInt();
                typedDst.frag_total = src.readInt();
                src.readByteSequence(typedDst.frag, ((com.rti.examples.JavaDDSFileTransfer.FILE_FRAGMENT_SIZE_MAX.VALUE)));
